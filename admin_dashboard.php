...
<head>
    ...
    <link rel="stylesheet" href="admin_dashboard.css"> <!-- Dashboard-specific CSS -->
</head>
<body>
    <!-- Navbar -->
    <div class="header-blue">
        <nav class="navbar navbar-dark navbar-expand-md navigation-clean-search">
                ...
                <a href="admin_dashboard.php"><img src="images/logo3.png" alt="Your Logo"></a>
    ...
    <div class="login-dark">
        <div class="container text-center">
            ...
            <p>Welcome, <?= $_SESSION['admin'] ?>. You are logged in as an admin.</p>

            <!-- Card-like Buttons -->
            <div class="form-group">
                <a href="web_contents.php" class="card-button mb-3">Web Contents</a>
                <a href="list_of_patients.php" class="card-button">Manage Users</a>
            </div>
        </div>
    </div>
 <!-- Footer -->
